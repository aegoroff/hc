...
-o [ --save ] arg           сохранить MD5 хэши файлов в указанный файл.
...
Вычисление MD5 хэша части файла (первый килобайт)

md5.exe -f file.txt -z 1024


Вычисление MD5 хэша части файла (один килобайт с пропуском первых 512 байт)
