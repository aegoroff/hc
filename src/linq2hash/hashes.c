            ...
            )
{
    ...
    hash->context_size_ = contextSize;
    hash->pfn_init_ = PfnInit;
    hash->pfn_update_ = PfnUpdate;
    hash->pfn_final_ = PfnFinal;
    hash->pfn_digest_ = PfnDigest;
...
void hsh_initialize_hashes(apr_pool_t* p)
{
    ...
    pool = p;
    hshp_set_hash("crc32", 2, sizeof(Crc32Context), CRC32_HASH_SIZE, FALSE, CRC32CalculateDigest, Crc32Init, Crc32Final, Crc32Update);
    hshp_set_hash("md2", 3, sizeof(sph_md2_context), SZ_MD2, FALSE, MD2CalculateDigest, sph_md2_init, sph_md2_close, sph_md2);
    hshp_set_hash("md4", 3, sizeof(sph_md4_context), SZ_MD4, FALSE, MD4CalculateDigest, sph_md4_init, sph_md4_close, sph_md4);
    hshp_set_hash("ntlm", 3, sizeof(sph_md4_context), SZ_MD4, TRUE, MD4CalculateDigest, sph_md4_init, sph_md4_close, sph_md4);
    hshp_set_hash("md5", 4, sizeof(sph_md5_context), SZ_MD5, FALSE, MD5CalculateDigest, sph_md5_init, sph_md5_close, sph_md5);
    hshp_set_hash("sha1", 4, sizeof(sph_sha1_context), SZ_SHA1, FALSE, SHA1CalculateDigest, sph_sha1_init, sph_sha1_close, sph_sha1);
    hshp_set_hash("sha224", 5, sizeof(sph_sha224_context), SZ_SHA224, FALSE, SHA224CalculateDigest, sph_sha224_init, sph_sha224_close, sph_sha224);
    hshp_set_hash("sha256", 6, sizeof(sph_sha256_context), SZ_SHA256, FALSE, SHA256CalculateDigest, sph_sha256_init, sph_sha256_close, sph_sha256);
    hshp_set_hash("sha384", 7, sizeof(sph_sha384_context), SZ_SHA384, FALSE, SHA384CalculateDigest, sph_sha384_init, sph_sha384_close, sph_sha384);
    hshp_set_hash("sha512", 8, sizeof(sph_sha512_context), SZ_SHA512, FALSE, SHA512CalculateDigest, sph_sha512_init, sph_sha512_close, sph_sha512);
    hshp_set_hash("ripemd128", 5, sizeof(sph_ripemd128_context), SZ_RIPEMD128, FALSE, RMD128CalculateDigest, sph_ripemd128_init, sph_ripemd128_close, sph_ripemd128);
    hshp_set_hash("ripemd160", 5, sizeof(sph_ripemd160_context), SZ_RIPEMD160, FALSE, RMD160CalculateDigest, sph_ripemd160_init, sph_ripemd160_close, sph_ripemd160);
    hshp_set_hash("ripemd256", 6, sizeof(hash_state), SZ_RIPEMD256, FALSE, RMD256CalculateDigest, rmd256_init, rmd256_done, rmd256_process);
    hshp_set_hash("ripemd320", 7, sizeof(hash_state), SZ_RIPEMD320, FALSE, RMD320CalculateDigest, rmd320_init, rmd320_done, rmd320_process);
    hshp_set_hash("tiger", 5, sizeof(sph_tiger_context), SZ_TIGER192, FALSE, TIGERCalculateDigest, sph_tiger_init, sph_tiger_close, sph_tiger);
    hshp_set_hash("tiger2", 5, sizeof(sph_tiger2_context), SZ_TIGER192, FALSE, TIGER2CalculateDigest, sph_tiger2_init, sph_tiger2_close, sph_tiger2);
    hshp_set_hash("whirlpool", 8, sizeof(sph_whirlpool_context), SZ_WHIRLPOOL, FALSE, WHIRLPOOLCalculateDigest, sph_whirlpool_init, sph_whirlpool_close, sph_whirlpool);
    hshp_set_hash("gost", 9, sizeof(gost_ctx), SZ_GOST, FALSE, GOSTCalculateDigest, rhash_gost_cryptopro_init, rhash_gost_final, rhash_gost_update);
    hshp_set_hash("snefru128", 10, sizeof(snefru_ctx), SZ_SNEFRU128, FALSE, SNEFRU128CalculateDigest, rhash_snefru128_init, rhash_snefru_final, rhash_snefru_update);
    hshp_set_hash("snefru256", 10, sizeof(snefru_ctx), SZ_SNEFRU256, FALSE, SNEFRU256CalculateDigest, rhash_snefru256_init, rhash_snefru_final, rhash_snefru_update);
    hshp_set_hash("tth", 5, sizeof(tth_ctx), SZ_TTH, FALSE, TTHCalculateDigest, rhash_tth_init, rhash_tth_final, rhash_tth_update);
    hshp_set_hash("haval-128-3", 5, sizeof(sph_haval_context), SZ_HAVAL128, FALSE, HAVAL128_3CalculateDigest, sph_haval128_3_init, sph_haval128_3_close, sph_haval128_3);
    hshp_set_hash("haval-128-4", 5, sizeof(sph_haval_context), SZ_HAVAL128, FALSE, HAVAL128_4CalculateDigest, sph_haval128_4_init, sph_haval128_4_close, sph_haval128_4);
    hshp_set_hash("haval-128-5", 5, sizeof(sph_haval_context), SZ_HAVAL128, FALSE, HAVAL128_5CalculateDigest, sph_haval128_5_init, sph_haval128_5_close, sph_haval128_5);
    hshp_set_hash("haval-160-3", 5, sizeof(sph_haval_context), SZ_HAVAL160, FALSE, HAVAL160_3CalculateDigest, sph_haval160_3_init, sph_haval160_3_close, sph_haval160_3);
    hshp_set_hash("haval-160-4", 5, sizeof(sph_haval_context), SZ_HAVAL160, FALSE, HAVAL160_4CalculateDigest, sph_haval160_4_init, sph_haval160_4_close, sph_haval160_4);
    hshp_set_hash("haval-160-5", 5, sizeof(sph_haval_context), SZ_HAVAL160, FALSE, HAVAL160_5CalculateDigest, sph_haval160_5_init, sph_haval160_5_close, sph_haval160_5);
    hshp_set_hash("haval-192-3", 5, sizeof(sph_haval_context), SZ_HAVAL192, FALSE, HAVAL192_3CalculateDigest, sph_haval192_3_init, sph_haval192_3_close, sph_haval192_3);
    hshp_set_hash("haval-192-4", 5, sizeof(sph_haval_context), SZ_HAVAL192, FALSE, HAVAL192_4CalculateDigest, sph_haval192_4_init, sph_haval192_4_close, sph_haval192_4);
    hshp_set_hash("haval-192-5", 5, sizeof(sph_haval_context), SZ_HAVAL192, FALSE, HAVAL192_5CalculateDigest, sph_haval192_5_init, sph_haval192_5_close, sph_haval192_5);
    hshp_set_hash("haval-224-3", 5, sizeof(sph_haval_context), SZ_HAVAL224, FALSE, HAVAL224_3CalculateDigest, sph_haval224_3_init, sph_haval224_3_close, sph_haval224_3);
    hshp_set_hash("haval-224-4", 5, sizeof(sph_haval_context), SZ_HAVAL224, FALSE, HAVAL224_4CalculateDigest, sph_haval224_4_init, sph_haval224_4_close, sph_haval224_4);
    hshp_set_hash("haval-224-5", 5, sizeof(sph_haval_context), SZ_HAVAL224, FALSE, HAVAL224_5CalculateDigest, sph_haval224_5_init, sph_haval224_5_close, sph_haval224_5);
    hshp_set_hash("haval-256-3", 5, sizeof(sph_haval_context), SZ_HAVAL256, FALSE, HAVAL256_3CalculateDigest, sph_haval256_3_init, sph_haval256_3_close, sph_haval256_3);
    hshp_set_hash("haval-256-4", 5, sizeof(sph_haval_context), SZ_HAVAL256, FALSE, HAVAL256_4CalculateDigest, sph_haval256_4_init, sph_haval256_4_close, sph_haval256_4);
    hshp_set_hash("haval-256-5", 5, sizeof(sph_haval_context), SZ_HAVAL256, FALSE, HAVAL256_5CalculateDigest, sph_haval256_5_init, sph_haval256_5_close, sph_haval256_5);
    hshp_set_hash("edonr256", 5, sizeof(edonr_ctx), SZ_EDONR256, FALSE, EDONR256CalculateDigest, rhash_edonr256_init, rhash_edonr256_final, rhash_edonr256_update);
    hshp_set_hash("edonr512", 5, sizeof(edonr_ctx), SZ_EDONR512, FALSE, EDONR512CalculateDigest, rhash_edonr512_init, rhash_edonr512_final, rhash_edonr512_update);
    hshp_set_hash("sha-3-224", 9, sizeof(sha3_ctx), SZ_SHA224, FALSE, SHA3224CalculateDigest, rhash_sha3_224_init, rhash_sha3_final, rhash_sha3_update);
    hshp_set_hash("sha-3-256", 9, sizeof(sha3_ctx), SZ_SHA256, FALSE, SHA3256CalculateDigest, rhash_sha3_256_init, rhash_sha3_final, rhash_sha3_update);
    hshp_set_hash("sha-3-384", 9, sizeof(sha3_ctx), SZ_SHA384, FALSE, SHA3384CalculateDigest, rhash_sha3_384_init, rhash_sha3_final, rhash_sha3_update);
    hshp_set_hash("sha-3-512", 9, sizeof(sha3_ctx), SZ_SHA512, FALSE, SHA3512CalculateDigest, rhash_sha3_512_init, rhash_sha3_final, rhash_sha3_update);
    hshp_set_hash("sha-3k-224", 9, sizeof(sha3_ctx), SZ_SHA224, FALSE, SHA3K224CalculateDigest, rhash_keccak_224_init, rhash_keccak_final, rhash_keccak_update);
    hshp_set_hash("sha-3k-256", 9, sizeof(sha3_ctx), SZ_SHA256, FALSE, SHA3K256CalculateDigest, rhash_keccak_256_init, rhash_keccak_final, rhash_keccak_update);
    hshp_set_hash("sha-3k-384", 9, sizeof(sha3_ctx), SZ_SHA384, FALSE, SHA3K384CalculateDigest, rhash_keccak_384_init, rhash_keccak_final, rhash_keccak_update);
    hshp_set_hash("sha-3k-512", 9, sizeof(sha3_ctx), SZ_SHA512, FALSE, SHA3K512CalculateDigest, rhash_keccak_512_init, rhash_keccak_final, rhash_keccak_update);
}
