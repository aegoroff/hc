...
egr4:$apr1$uths1zqo$4i/Rducjac63A.ExW4K6N1";
    ...
    public abstract class Apc<T> : ExeWrapper<T> where T : Architecture, new()
    {
        ...
        public void CrackAll()
        {
            ...
            Asserts.StringMatching(string.Join("\r\n", results), @"Login: egr1 Hash: 2eed68ccbf8405b0d6cc5a62df1edc54
...
Password is: 123");
        ...
        public void CrackOne()
        {
            ...
            Asserts.StringMatching(string.Join("\r\n", results), @"Login: egr2 Hash: \{SHA\}QL0AFWMIX8NRZTKeof9cXsvbvu8=
Attempts: \d+ Time 00:00:0\.\d+
Password is: 123");
        }
        ...
        public void IncompatibleOptions()
        {
            ...
            Asserts.StringMatching(string.Join("\r\n", results), string.Format(@"Apache passwords cracker \d+?\.\d+?\.\d+?\.\d+? {0}
...
Incompatible options: impossible to crack file and hash simultaneously", Arch));
        ...
        public void CrackHashSuccess()
        {
            ...
            Asserts.StringMatching(string.Join("\r\n", results), @"Attempts: \d+ Time 00:00:0\.\d+
Password is: 123");
        }
