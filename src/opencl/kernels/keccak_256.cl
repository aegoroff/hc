...
static int prkeccak_256_compare(__global const uchar* k_hash, uchar* password, const int length) {
  return prsha3_compare_reg(k_hash, password, length, 136u, 32u, (uchar)1);
}

__kernel void prkeccak_256_kernel(__global uchar* result,
