...
static int prkeccak_512_compare(__global const uchar* k_hash, uchar* password, const int length) {
  return prsha3_compare_reg(k_hash, password, length, 72u, 64u, (uchar)1);
}

__kernel void prkeccak_512_kernel(__global uchar* result,
