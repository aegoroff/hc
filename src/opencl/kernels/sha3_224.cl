...
static int prsha3_224_compare(__global const uchar* k_hash, uchar* password, const int length) {
  return prsha3_compare_reg(k_hash, password, length, 144u, 28u, (uchar)6);
}

__kernel void prsha3_224_kernel(__global uchar* result,
