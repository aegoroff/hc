...
static int prsha3_384_compare(__global const uchar* k_hash, uchar* password, const int length) {
  return prsha3_compare_reg(k_hash, password, length, 104u, 48u, (uchar)6);
}

__kernel void prsha3_384_kernel(__global uchar* result,
