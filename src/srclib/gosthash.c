...
static const uint32_t gost_sbox_1[256] = {
...
static const uint32_t gost_sbox_2[256] = {
...
static const uint32_t gost_sbox_3[256] = {
...
static const uint32_t gost_sbox_4[256] = {
...
static void gosthash_compress(uint32_t * h, uint32_t * m)
{
	uint32_t i;
...
void mutils_bzero(void *s, const uint32_t n)
{
	uint32_t *stmp = (uint32_t *) s;
	uint32_t i = 0;
...
static void gosthash_bytes(GostHashCtx * ctx, const uint8_t * buf, uint32_t bits)
{
	uint32_t i;
	uint32_t j;
	uint32_t a, c, m[8];
