...
__host__ void HC_GPU_FN(blake2s_on_gpu_prepare)(int device_ix, const unsigned char* dict, size_t dict_len,
...
__host__ void HC_GPU_FN(blake2s_run_on_gpu)(gpu_tread_ctx_t* ctx, const size_t dict_len) {
