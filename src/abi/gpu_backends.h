...
void cuda_blake3_run_on_gpu(gpu_tread_ctx_t* ctx, const size_t dict_len);
void cuda_blake3_on_gpu_prepare(int device_ix, const unsigned char* dict, size_t dict_len, const unsigned char* hash, gpu_tread_ctx_t* ctx);
...
void ocl_blake3_run_on_gpu(gpu_tread_ctx_t* ctx, const size_t dict_len);
void ocl_blake3_on_gpu_prepare(int device_ix, const unsigned char* dict, size_t dict_len, const unsigned char* hash, gpu_tread_ctx_t* ctx);
