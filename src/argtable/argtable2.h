...
struct arg_hdr
   ...
   size_t      mincount;    /* Minimum number of occurences of this option accepted */
   size_t      maxcount;    /* Maximum number of occurences if this option accepted */
...
struct arg_lit
   {
   struct arg_hdr hdr;      /* The mandatory argtable header struct */
   size_t count;               /* Number of matching command line args */
   };
...
struct arg_end
   {
   struct arg_hdr hdr;      /* The mandatory argtable header struct */
   size_t count;               /* Number of errors encountered */
...
struct arg_end* arg_end(size_t maxerrors);


/**** other functions *******************************************/
int arg_nullcheck(void **argtable);
size_t arg_parse(int argc, const char * const*argv, void **argtable);
