...
*/
/*!
 * \brief   The file contains Whirlpool CUDA code implementation
 * \author  \verbatim
...
__constant__ static uint64_t MAGIC_TABLE[256] = {
...
__host__ void whirl_on_gpu_prepare(int device_ix, const unsigned char* dict, size_t dict_len, const unsigned char* hash, gpu_tread_ctx_t* ctx) {
