...
void InitializeHashes(apr_pool_t* p)
{
    ...
    SetHash("haval-128-3",
            5,
            sizeof(sph_haval_context),
            SZ_HAVAL128,
            HAVAL128_3CalculateDigest,
            sph_haval128_3_init,
