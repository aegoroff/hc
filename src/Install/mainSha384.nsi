...
!define PRODUCT_NAME "SHA384 Calculator"
!define PRODUCT_PUBLISHER "Egoroff"
!define PRODUCT_WEB_SITE "http://www.egoroff.spb.ru/"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\sha384.exe"
...
OutFile "${Configuration}\sha384calculator${OUTPUT_FILE_SUFFIX}.exe"
...
Section "MainSection" SEC01
  ...
  File "..\..\docs\sha384\Readme.ru.txt"
  File "..\..\docs\sha384\Readme.en.txt"
  
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\$(PROGRAM_NAME).lnk" "cmd.exe" "/K sha384.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\sha384.exe"
