...
!define PRODUCT_NAME "SHA512 Calculator"
!define PRODUCT_PUBLISHER "Egoroff"
!define PRODUCT_WEB_SITE "http://www.egoroff.spb.ru/"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\sha512.exe"
...
!include "LanguageStringsSha512.nsh"

; MUI end ------

Name "${PRODUCT_NAME} ${PRODUCT_VERSION}"
OutFile "${Configuration}\sha512calculator${OUTPUT_FILE_SUFFIX}.exe"
...
Section "MainSection" SEC01
  ...
  File "..\..\docs\sha512\Readme.ru.txt"
  File "..\..\docs\sha512\Readme.en.txt"
  
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\$(PROGRAM_NAME).lnk" "cmd.exe" "/K sha512.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\sha512.exe"
