...
!define PRODUCT_NAME "WHIRLPOOL Calculator"
!define PRODUCT_PUBLISHER "Egoroff"
!define PRODUCT_WEB_SITE "http://www.egoroff.spb.ru/"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\whirlpool.exe"
...
!include "LanguageStringsWhirlpool.nsh"

; MUI end ------

Name "${PRODUCT_NAME} ${PRODUCT_VERSION}"
OutFile "${Configuration}\whirlpoolcalculator${OUTPUT_FILE_SUFFIX}.exe"
...
Section "MainSection" SEC01
  ...
  File "..\..\docs\whirlpool\Readme.ru.txt"
  File "..\..\docs\whirlpool\Readme.en.txt"
  
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\$(PROGRAM_NAME).lnk" "cmd.exe" "/K whirlpool.exe"
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\whirlpool.exe"
